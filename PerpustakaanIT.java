/*tugas sesi 3 algodata Jihad Razdiansyah 20200040050
membuat array list data mahasiswa,buku,transaksi */

import java.util.ArrayList;
import java.util.Scanner;

public class PerpustakaanIT {
    public static void main(String[] args) {

        int keluar = 0;
        ArrayList <Mahasiswa> dataMahasiswa = new ArrayList<>();

        dataMahasiswa.add(new Mahasiswa("20200040001", "Jihad Razdiansyah"));
        dataMahasiswa.add(new Mahasiswa("20200040002", "Roihan Kusuma Wardana"));
        dataMahasiswa.add(new Mahasiswa("20200040003", "Sadam Fadilah1"));
        dataMahasiswa.add(new Mahasiswa("20200040004", "Salman Alfarizi"));
